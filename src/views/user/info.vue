    ...
    <div class="info-page">
        ...
        <div class="card">
            ...
            <div class="link-cards">
                <div v-if="subscribeUrl" class="link-card">
                    <p class="link-card-label">
                ...
                <div
                    ...
                    :key="`${item.url}-${index}`"
                >
                    <p class="link-card-label">{{ item.name }}</p>
                    <div class="link-row">
                ...
                <p
                    v-if="!subscribeUrl && normalizedLinks.length === 0"
                    class="empty-text"
                >
                    {{ $t('user.info.noLinks') }}
                </p>
            ...
            <div class="tutorial-card">
                ...
                <div class="tutorial-platform-row">
                    ...
                    <div
                        ...
                        @click="
                            activeTutorial =
                                activeTutorial === 'windows' ? null : 'windows'
                        "
                    >
                    ...
                    <div
                        ...
                        @click="
                            activeTutorial =
                                activeTutorial === 'android' ? null : 'android'
                        "
                    >
